...
class PostController extends Controller
{
    ...
    public function store(Requests\StorePostRequest $request)
    {
        ...
        return redirect(route('backend.post.index'))->with('status', 'Post has been created.');
    }
    ...
    public function confirm($id)
    {
        ...
        return view('backend.post.confirm', compact('post'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('backend.post.index'))->with('status', 'Post has been deleted.');
    }
}
